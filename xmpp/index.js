            ...
            functions.SendMessage(JSON.stringify(
                {
                    ...
                    "account_id": `Lunar Bot${BotNumber != 0 ? BotNumber : ""}`,
                    "account_dn": "Lunar Bot",
                    "member_state_updated": {
                        "urn:epic:member:joinrequestusers_j": JSON.stringify({ "users": [{ "id": `Lunar Bot${BotNumber != 0 ? BotNumber : ""}`, "dn": "Lunar Bot", "plat": "WIN", "data": JSON.stringify({ "CrossplayPreference_i": "1", "SubGame_u": "1" }) }] }),
                        "urn:epic:member:dn_s": `Lunar Bot`,
                    },
                    "joined_at": new Date(),
                    "updated_at": new Date()
                }
